...
This is a tool used to convert maps created in Tiled for use in our GBA Jam entry, Sleep Paradox. To compile Sleep Paradox from scratch on your machine, you need to have this installed on your system. Aside from exporting tilemap data for use with Butano, it also exports data such as enemy spawn points and portals between different zones/rooms in the game.
